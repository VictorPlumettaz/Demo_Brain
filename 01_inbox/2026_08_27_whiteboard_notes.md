...
- remnant rack → 11% ?? confirm number w Lena Mullian
- GN go live 5.10 NOT on v2 — does Timo know. someone has to say it out loud
- .opt writer — DO NOT TOUCH (marco, twice, underlined)
- priya: CI or no signoff
- build agent 16GB — nils, ask
- second dry run before the training days or after ?? does it matter
- something re invoice run month end, missed the start of that bit
- label layout template — where does that live actually
...
also a box round "who signs off the data" with nothing in it
