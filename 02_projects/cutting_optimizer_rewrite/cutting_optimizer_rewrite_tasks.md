...
- [ ] #priority/high Recheck benchmark jobs 112, 118, 203 — Robin, the line below says done 2026-08-18 but the 19.08 whiteboard and the overview status both still call them red, see [[cutting_optimizer_rewrite_overview]]; the diagnostic step (Marco's thickness-sort theory) is still open in [[cutting_optimizer_rewrite_meeting_2026_08_04]]
...
- [x] #priority/high Stop benchmark jobs 112, 118 and 203 regressing — Robin, worst is 4.1 points of yield below legacy [completion:: 2026-08-18] — disputed, see the recheck task above
